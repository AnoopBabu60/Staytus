...
@section('title', 'Staytus Admin-Login')
            ...
            <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
                ...
                <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                    ...
                    <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                        ...
                        <!--end::Aside header-->
                        <!--begin::Aside title-->
                        <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">Staytus
                        <br />Admin</h3>
                        <!--end::Aside title-->
                    </div>
                    <!--end::Aside Top-->
                    ...
                    style="background-image: url(admin/media/svg/illustrations/restrosvg.svg)"></div>
                    <!--end::Aside Bottom-->
                </div>
                <!--begin::Aside-->
                <!--begin::Content-->
                        ...
                        <div class="login-form login-signin">
                            ...
                            <form class="form"  method="POST" action="{{ route('login') }}">
                                ...
                                <div class="pb-13 pt-lg-0 pt-5">
                                    <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Staytus Admin</h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="email" placeholder="Email" autocomplete="off" />
                                </div>
                                <!--end::Form group-->
                                <!--begin::Form group-->
                                <div class="form-group">
